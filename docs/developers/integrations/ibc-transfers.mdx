...
Full list (mainnet + testnet topology, denoms, escrows): [IBC channels](/ibc/channels).
Hermes testnet template: [Hermes setup → Testnet](/ibc/hermes-setup#testnet-safro-testnet-1).
